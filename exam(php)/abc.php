<!-- <?php 
$conn = mysqli_connect('localhost','root','','test') or die("conection fail");
...
<?php
  ...
  if(isset($_POST['btn']))
  {
    if(isset($_GET['id']))
	{
      ...
      $qry="update student set sname='".$_POST['fname']."',saddress='".$_POST['add']."',sclass='".$_POST['class']."',phone_no='".$_POST['number']."' where sid=".$_GET['id'];
       mysqli_query($con,$qry);
  
    }else
	{
		
       $qry= "insert into student values(NULL,'".$_POST['fname']."','".$_POST['add']."','".$_POST['class']."','".$_POST['number']."')";
       mysqli_query($con,$qry);
    }
  }
...
<div class="container">
  ...
  while($row=mysqli_fetch_assoc($result)){
    ...
    <tr>
      ...
      <button class="btn btn-primary"><a href="abc.php?id=<?php echo $row['sid'];?>">edit</a>  
      <button class="btn btn-danger"><a href="delete.php?sid=<?php echo $row['sid'];?>">delete</a></td>
